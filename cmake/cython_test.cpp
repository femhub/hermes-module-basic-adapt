/* Generated by Cython 0.14.1 on Fri Mar 11 00:48:36 2011 */
...
static std::vector<int> __pyx_f_11cython_test_array2vector_int(PyObject *); /*proto*/
#define __Pyx_MODULE_NAME "cython_test"
static int __pyx_module_is_main_cython_test = 0;
 ...
 * 
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_a, __pyx_v_i, sizeof(Py_ssize_t), PyInt_FromSsize_t); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = __Pyx_PyInt_AsInt(__pyx_t_3); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_WriteUnraisable("cython_test.array2vector_int");
  __pyx_L0:;
...
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit_cython_test(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cython_test"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cython_test");
