  ...
  BA.set_material_markers(mat_markers);
  ...
  if (n_bc_dirichlet > 0) BA.set_dirichlet_markers(bdy_markers_dirichlet);
  ...
  if (n_bc_dirichlet > 0) BA.set_dirichlet_values(bdy_markers_dirichlet, bdy_values_dirichlet);
  ...
  if (n_bc_neumann > 0) BA.set_neumann_markers(bdy_markers_neumann);
  ...
  if (n_bc_neumann > 0) BA.set_neumann_values(bdy_values_neumann);
  ...
  if (n_bc_newton > 0) BA.set_newton_markers(bdy_markers_newton);
  ...
  if (n_bc_newton > 0) BA.set_newton_values(bdy_values_newton);
